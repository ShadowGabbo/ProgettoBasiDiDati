<?php
    ...
    if (isset($_POST)){
        if (!empty($_POST['id_docente'])) {
            $docente_id = $_POST['id_docente'];
            $arr = get_teacher($docente_id);
        }
    }
?>
<!doctype html>
