...
<html lang="en">
  <head>
    ...
    <title>Modifica corso di studio</title>
  ...
  <div class="container-fluid">
    ...
    <div class="mb-3">
        ...
        <input value="<?php echo $arr[2]?>" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="tipo">
    </div>
    <div class="mb-3">
        <label for="exampleInputEmail1" class="form-label">Descrizione</label>
        <input value="<?php echo $arr[3]?>" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="descrizione">
    </div>
